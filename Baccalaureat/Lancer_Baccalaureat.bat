@echo off
title Baccalaureat - Serveur de jeu
cd /d "%~dp0"

echo =========================================
echo    BACCALAUREAT - Demarrage du serveur
echo =========================================
echo.
...
echo =========================================
echo   Le serveur va demarrer sur le port 2000
echo.
...
if defined LOCALIP (
    ...
    echo     http://VOTRE_IP_LOCALE:2000/player/1
)
echo =========================================
echo.
