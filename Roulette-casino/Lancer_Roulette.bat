...
echo Demarrage du serveur sur http://localhost:7777/master.html ...
...
REM Ouvre directement la page maitre (creation / chargement de partie) dans le navigateur par defaut
start "" "http://localhost:7777/master.html"
